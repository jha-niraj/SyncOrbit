            ...
            <div className="container px-6 lg:px-8 mx-auto">
                <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
                    <div className="mb-12 text-center">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-4 dark:text-white">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                        <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300 dark:bg-neutral-900 dark:border-neutral-800">
                            <div className="w-12 h-12 bg-pulse-100 rounded-full flex items-center justify-center mb-4 dark:bg-pulse-900/20">
                            ...
                            <h4 className="text-lg font-semibold mb-2 dark:text-white">Advanced Sensors</h4>
                            <p className="text-gray-600 dark:text-gray-400">High-precision sensors provide real-time environmental awareness and object recognition.</p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300 dark:bg-neutral-900 dark:border-neutral-800">
                            ...
                            <h4 className="text-lg font-semibold mb-2 dark:text-white">Adaptive Learning</h4>
                            <p className="text-gray-600 dark:text-gray-400">Continuously learns from interactions to improve performance and personalize responses.</p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300 dark:bg-neutral-900 dark:border-neutral-800">
                            ...
                            <h4 className="text-lg font-semibold mb-2 dark:text-white">Fluid Movement</h4>
                            <p className="text-gray-600 dark:text-gray-400">Engineered for natural, human-like movement with high degrees of freedom in all joints.</p>
                        </div>
                    </div>
                </div>
            </div>
