...
import { Plus, Clock, CheckCircle, ListTodo, GripVertical } from "lucide-react"
...
export function KanbanBoard({ tasks, userRole, onTaskUpdate, projectId }: KanbanBoardProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {columns.map((column) => (
          ...
          >
            ...
            <CardContent>
              <div className={`min-h-[400px] space-y-3 p-2 rounded-lg border-2 border-dashed transition-colors ${
                draggedOverColumn === column.id 
