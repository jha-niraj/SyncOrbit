...
export default function AssociationsPageClient({ initialAssociations, initialInvitations }: AssociationsPageClientProps) {
    const { data: session } = useSession()
    const [associations, setAssociations] = useState<UserAssociations | null>(initialAssociations)
