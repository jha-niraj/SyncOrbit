...
import { formatCurrency, getCurrencySymbol, getPaymentProgress } from "@/store/useProjectStore"
			...
			<div className="min-h-screen bg-background flex items-center justify-center">
				<div className="text-center">
					...
					<p className="text-muted-foreground mb-4">
						{result.error || "The project you're looking for doesn't exist."}
					</p>
					<Link href="/dashboard">
						<Button>
										...
										<div className="flex items-center gap-4">
											<Avatar className="h-12 w-12 border-2 border-gray-200">
												...
												<AvatarFallback className="bg-black text-white text-lg font-bold">
													{project.user.name?.split(" ").map(n => n[0]).join("") || "C"}
												</AvatarFallback>
											</Avatar>
											<div>
						...
						<div className="lg:col-span-2">
							...
							<Tabs defaultValue="tasks" className="w-full">
								<TabsList className="grid w-full grid-cols-2">
									...
									<TabsTrigger value="feedback" data-value="feedback" className="flex items-center gap-2">
								...
								<CardContent>
									<div className="space-y-4">
										...
										<div className="flex justify-between items-center">
											...
											<span className="font-medium text-blue-600">{project.feedbacks.length}</span>
										</div>
										<div className="flex justify-between items-center">
